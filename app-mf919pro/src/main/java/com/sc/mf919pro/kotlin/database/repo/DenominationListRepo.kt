...
import com.sc.mf919pro.kotlin.database.model.DbModelDenominationListInsert
...
class DenominationListRepo {
    companion object {
        ...
        fun insertToDb(mContext: Context, dbModelDenominationInsert: DbModelDenominationListInsert): Boolean {
            val dbHandler = DbHandler.getInstance(mContext)!!
            return dbHandler.insertToDb(DatabaseTables.DENOMINATION_LIST, dbModelDenominationInsert)
        }
        ...
        fun updateData(mContext: Context, updateMap: HashMap<Any, Any>, criteriaMap: HashMap<Any, Any>): Boolean {
            ...
            return dbHandler.updateTableValue(DatabaseTables.DENOMINATION_LIST, updateMap, criteriaMap) > 0
        }
