...
public class KeypadNum extends LinearLayout implements View.OnClickListener {
...
//    private LinearLayout button_qr_scan;
    ...
    public KeypadNum(Context context) {
        super(context);
        init(context);
    }

    public KeypadNum(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context);
    }

    public KeypadNum(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.keypadnew, this, true);
    ...
    private void insertValue(String value) {
        ...
        if (textView == null) {
            ...
            if(formatter != null) {
                textView.setText(formatter.format(msg));
            } else {
    ...
    private void visibleKeypad(Boolean visibility) {
        if (!visibility) {
            ...
            button_00.setVisibility(View.INVISIBLE);
            ...
            button_00.setVisibility(View.VISIBLE);
    ...
    public void setFilter(TextView tv, boolean _isAmount, int _maxLen, TextFormatter _formatter) {
        isAmount = _isAmount;
        maxLen = _maxLen;
