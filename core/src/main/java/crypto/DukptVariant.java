...
public class DukptVariant {
    ...
    //ALIFTEST
    public byte[] ipekComputeKey(byte[] initPinEncrKey, byte[] keySerialNumber) throws Exception {
        return Dukpt.ipekComputeKey(initPinEncrKey, keySerialNumber, _keyRegisterBitmask, _dataVariantBitmask);
    }
