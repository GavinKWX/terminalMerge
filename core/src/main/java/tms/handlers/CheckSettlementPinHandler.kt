...
import tms.models.TerminalPINRequestModel
import tms.models.TerminalPINResponseModel
import java.io.IOException

class CheckSettlementPinHandler(private val envManager: EnvironmentManager) {
	private val className: String = (CheckSettlementPinHandler::class.qualifiedName).toString()
	...
	fun invoke(
		...
		val resp = HelperHttp.invokeSend(
			log,
			apiUrl = envManager.get(EnvironmentVariables::baseUrl) + "tms/CheckSettlementPIN",
