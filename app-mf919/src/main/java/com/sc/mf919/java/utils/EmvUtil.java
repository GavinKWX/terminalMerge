...
public class EmvUtil {
    ...
    public static Bundle getInitTermConfig() {
        ...
        bundle.putByteArray(EmvTermCfgConstrants.TRANS_PROP_9F66, new byte[]{0x36, (byte) 0x00, (byte) 0xC0, (byte) 0x00}); //PROD
    ...
    public static Bundle getTransBundle(String amount, String cashOutAmount, int channel, boolean isEnableContact, boolean isEnableContactless) {
        ...
        //bundle.putInt(EmvTransDataConstrants.ISQPBOCFORCEONLINE, 1);  // CERTIFICATION
        bundle.putInt(EmvTransDataConstrants.ISQPBOCFORCEONLINE, 0);  //PROD
    ...
    public static String readTrack2() {
        ...
        Utils.debugLogPrint(TAG, "readTrack2: " + track2);
