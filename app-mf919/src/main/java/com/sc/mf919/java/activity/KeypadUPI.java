...
public class KeypadUPI extends LinearLayout implements View.OnClickListener {
...
//    private LinearLayout button_back;
    ...
    public KeypadUPI(Context context) {
        super(context);
        init(context);
    }

    public KeypadUPI(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context);
    }

    public KeypadUPI(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.keypadupi, this, true);
