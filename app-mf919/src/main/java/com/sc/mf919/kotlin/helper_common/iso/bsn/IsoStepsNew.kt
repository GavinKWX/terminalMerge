package com.sc.mf919.kotlin.helper_common.iso.bsn
...
object IsoStepsBSNNew {
        ...
        if(encDesField[0] != 0){
                ...
                if(iThisLen > 0){
                    ...
                    when(iThisField){
                        35 -> {
                            ...
                            helperLog.appendLine(logClassName, "new strTrack2 :: ${maskTrack2(strTrack2)}")
            ...
            if(de57HexString.length > 6){
                ...
                if((de57HexString.length % 2) != 0){
                    de57HexString += 0
                    helperLog.appendLine(logClassName, "NEW CLEAR before padding [] :: $de57HexString")
                }
    ...
    fun parseIsoResp(helperLog: HelperLog, isoRespByte: ByteArray, isoRespByteOffset: Int, isoRespByteLen: Int) {
        ...
        if(bf57.isNotEmpty()){
            ...
            certLog { "Dukpt Hex :: ${Dukpt.toHex(TransData.dukpt)}" }
    ...
    fun dukptDeriv(ipek: ByteArray, ksnHexString: String): ByteArray {
        ...
        println("Current KSN :: $ksnHexString")
        println("Current Dukpt :: " + Dukpt.toHex(dataKey))
        return dataKey
    }
    ...
    fun KCVDeriv(dukpt: ByteArray): ByteArray {
        ...
        println("TLE Header KCV :: " + Dukpt.toHex(kcv))
        return kcv
    }
